        ...
        <div>
                ...
                {announcements.map((announcement) => (
                  ...
                  >
                    <div className="flex items-center mb-2">
                      {announcement.isPinned && (
                        <svg
                          className="w-4 h-4 text-blue-600 dark:text-blue-400 mr-1"
                          fill="currentColor"
                          viewBox="0 0 20 20"
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mt-6">
            ...
            <div className="space-y-3">
              <Link
                to="/evaluate"
                className="block w-full py-2 px-4 bg-blue-600 text-white text-center rounded hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 transition"
              >
                Start New Evaluation
              </Link>
              <Link
                to="/profile"
                className="block w-full py-2 px-4 bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-white text-center rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition"
              >
                View Profile
              </Link>
              <Link
