...
const ClubAdminDashboard = () => {
  ...
  const handleScheduleEvaluation = () => {
    if (
      !newEvaluation.title ||
      !newEvaluation.scheduledDate ||
      !newEvaluation.speakerId ||
      !newEvaluation.evaluatorId
    ) {
    ...
    const speakerName =
      clubMembers.find((m) => m.id === newEvaluation.speakerId)?.username ||
      "Unknown";
    const evaluatorName =
      clubMembers.find((m) => m.id === newEvaluation.evaluatorId)?.username ||
      "Unknown";
                  ...
                  {clubSettings.evaluationCategories.map((category, index) => (
                    <div key={index} className="flex items-center">
                      <input
                        ...
                        onChange={(e) => {
                          const updatedCategories = [
                            ...clubSettings.evaluationCategories,
                          ];
                      ...
                      <button
                        onClick={() => {
                          const updatedCategories =
                            clubSettings.evaluationCategories.filter(
                              (_, i) => i !== index
                            );
                          setClubSettings({
                            ...clubSettings,
