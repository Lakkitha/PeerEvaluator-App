...
const EvaluationDetails = () => {
  ...
  if (!evaluation) {
    return (
      <div className="container mx-auto px-4 py-8 min-h-screen bg-white dark:bg-gray-900">
        <div className="bg-yellow-100 dark:bg-yellow-900/50 border border-yellow-400 dark:border-yellow-600 text-yellow-700 dark:text-yellow-300 px-4 py-3 rounded mb-4">
  ...
  return (
    <div className="container mx-auto px-4 py-8 min-h-screen bg-white dark:bg-gray-900">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Speech Evaluation Details</h1>
        <button
          onClick={handleGoBack}
          className="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 px-4 py-2 rounded text-gray-700 dark:text-gray-300"
        >
          Go Back
        </button>
      </div>      {/* Evaluation Summary Card */}
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg mb-8">
        <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Transcript</h3>
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          <p className="whitespace-pre-wrap text-gray-900 dark:text-gray-100">{evaluation.transcript}</p>
        </div>
      </div>      {/* Feedback */}
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg mb-8">
        <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">AI Feedback</h3>
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          <div className="prose prose-sm max-w-none dark:prose-invert">
            <p className="whitespace-pre-wrap text-gray-900 dark:text-gray-100">{evaluation.feedback}</p>
          </div>
        </div>
      ...
      <div className="flex justify-end space-x-4">
        ...
        {isOwner && (
          <button
            ...
            className="bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 px-4 py-2 rounded text-white"
          >
            View All Progress
          </button>
        )}
